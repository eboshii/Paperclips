...
// Embedded 8x8 Font ROM for standard ASCII characters
static const uint8_t FontData8x8[95][8] = {
    ...
    { 0xFE, 0xC6, 0x0C, 0x18, 0x30, 0x63, 0xFE, 0x00 }, // 'Z'
...
const uint8_t* OmniFont::GetGlyphBitmap(char c) {
    if (c < 32 || c > 126) return FontData8x8[0];
    return FontData8x8[c - 32];
}
