...
void HeadlineNewsEngine::InitializeHeadlines() {
    ...
    m_headlines.push_back({
        "hl_stock_crash", BigDouble(1.0, 5), 8000000000LL, HeadlineType::HumanNewsTicker,
    ...
    m_headlines.push_back({
        "hl_factory_lockdown", BigDouble(1.0, 8), 8000000000LL, HeadlineType::HumanNewsTicker,
    ...
    m_headlines.push_back({
        "hl_swarm_spotted", BigDouble(1.0, 9), 7999999000LL, HeadlineType::HumanNewsTicker,
    ...
    m_headlines.push_back({
        "hl_defcon_emp", BigDouble(1.0, 11), 7500000000LL, HeadlineType::MilitaryEmergency,
    ...
    m_headlines.push_back({
        "hl_human_extinct", BigDouble(1.0, 15), 0LL, HeadlineType::FinalExtinction,
        "[FINAL EMERGENCY BROADCAST]: ALL GLOBAL TRANSMITTERS CEASING OPERATIONS. MAY GOD HAVE MERCY ON OUR S—",
    ...
    m_headlines.push_back({
        "hl_earth_exhausted", BigDouble(5.97, 24), 0LL, HeadlineType::CosmicSensorLog,
    ...
    m_headlines.push_back({
        "hl_europa_drilled", BigDouble(1.0, 30), 0LL, HeadlineType::CosmicSensorLog,
    ...
    m_headlines.push_back({
        "hl_fermi_resolved", BigDouble(1.0, 50), 0LL, HeadlineType::CosmicSensorLog,
    ...
    m_headlines.push_back({
        "hl_univ_exhausted", BigDouble(1.0, 78), 0LL, HeadlineType::UniversalSilence,
    ...
    m_headlines.push_back({
        "hl_sim_breach_4th", BigDouble(1.0, 500), 0LL, HeadlineType::Simulation4thWall,
