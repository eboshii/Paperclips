    ...
    initCatalog() {
        this.buildings = [
            ...
            new BuildingTier({
                ...
                baseCPS: new BigDouble(4.0, 0),
                costMultiplier: 1.15,
                unlockThresholdClips: new BigDouble(100, 0),
                icon: '🔨',
            ...
            new BuildingTier({
                ...
                name: 'Laser Sinterer',
                category: 'Factory Assembly',
                baseCost: new BigDouble(1500, 0),
                baseCPS: new BigDouble(35.0, 0),
                costMultiplier: 1.14,
                unlockThresholdClips: new BigDouble(1200, 0),
                icon: '🔥',
            ...
            new BuildingTier({
                ...
                category: 'Factory Assembly',
                baseCost: new BigDouble(18000, 0),
                baseCPS: new BigDouble(300.0, 0),
                costMultiplier: 1.13,
                unlockThresholdClips: new BigDouble(15000, 0),
                icon: '🏭',
            ...
            new BuildingTier({
                ...
                category: 'Factory Assembly',
                baseCost: new BigDouble(150000, 0),
                baseCPS: new BigDouble(2500.0, 0),
                costMultiplier: 1.13,
            ...
            new BuildingTier({
                ...
                baseCPS: new BigDouble(25000.0, 0),
                costMultiplier: 1.12,
